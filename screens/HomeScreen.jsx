...
import { View, Text, Dimensions, Animated, PanResponder, useColorScheme, ScrollView, TouchableOpacity } from 'react-native';
...
const HomeScreen = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get('http://localhost:3002/getUserData/jif2389y7f2jh1hid');
                                ...
                                <View style={styles.sortContainer}>
                                    ...
                                    {dropdownVisible && (
                                        <View style={styles.dropdown}>
                                            <TouchableOpacity onPress={() => handleSortBy('chronological')} style={styles.dropdownItem}>
                                                <Text style={[styles.dropdownText, highlightedSort === 'chronological' ? styles.highlight : null]}>Chronological</Text>
                                            </TouchableOpacity>
                                            <TouchableOpacity onPress={() => handleSortBy('time')} style={styles.dropdownItem}>
                                                <Text style={[styles.dropdownText, highlightedSort === 'time' ? styles.highlight : null]}>Time</Text>
                                            </TouchableOpacity>
                                        </View>
                                    )}
                                </View>
